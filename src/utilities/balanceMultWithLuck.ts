 ...
 *
 * The probability of an effect (i.e. “1 in $denominator chance”) is used to determine the _average_ mult value. For example, with lucky card's 1 in 5 chance, the average value used would be 1/5*20 = 4. The numerator is raised by the number of Oops! All 6s jokers. In theory, having Oops! All 6s four times would guarantee lucky cards to trigger because their probability would be 5/5 = 1. The `luck` parameter modifies the result by either implying no luck (unless the number of Oops! All 6s jokers results in a probability of 1) or all luck.
 */
